#!/usr/bin/env python3
"""Generate Python TF regression HDF5 outputs for Clarissa debug data."""
...
from time_frequency_stats_debug_shared import (  # noqa: E402
    BIDS_ROOT,
    TrialSlopeTFRegressionResolver,
    build_regression_params,
    build_regression_writer,
...
def main() -> list[Path]:
    ...
    processor = TimeFrequencyRegressionProcessing(
        build_regression_params(),
        resolver=TrialSlopeTFRegressionResolver(),
    )
    writer = build_regression_writer()
