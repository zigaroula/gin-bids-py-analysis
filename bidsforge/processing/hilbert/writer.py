...
from bidsforge.bids.helpers import modify_entities
from bidsforge.processing.base import (
    BaseProcessingResult,
    BaseProcessingWriter,
)
from bidsforge.processing.utils.events import downsample_events
...
class HilbertProcessingWriter(BaseProcessingWriter):
    ...
    :attr:`~bidsforge.processing.hilbert.HilbertWriterParams.output_format`:
    ...
    * **BrainVision** (``"brainvision"``) — one file triplet
    ...
    Pass a :class:`~bidsforge.processing.hilbert.HilbertWriterParams`
